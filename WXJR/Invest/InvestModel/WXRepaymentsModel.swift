...
class WXRepaymentsModel: NSObject {
    ...
    init(json: NSDictionary) {
        ...
        dueDate = (json.objectForKey("repayment") as! NSDictionary).objectForKey("dueDate") as? Int
    }
}
